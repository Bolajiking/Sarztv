  ...
  if (step === 'success') {
    return (
      <div className="mt-4 rounded-xl bg-[#111111] border border-green-500/30 p-6 shadow-lg flex flex-col items-center justify-center text-center min-h-[180px] animate-in fade-in zoom-in duration-300">
        ...
        <h3 className="text-white font-bold text-lg mb-1">Offering Received</h3>
        <p className="text-slate-400 text-sm">Thank you for your generosity!</p>
        <p className="text-[#c5a059] text-xs mt-2 font-medium"> deducted from Mobile Purse</p>
      </div>
    );
  }
  ...
  if (step === 'confirm') {
    return (
      <div className="mt-4 rounded-xl bg-[#111111] border border-[#c5a059]/30 p-6 shadow-lg flex flex-col items-center justify-center text-center min-h-[180px] animate-in fade-in slide-in-from-bottom-2 duration-300">
        <h3 className="text-white font-bold text-lg mb-2">Confirm Offering</h3>
        <p className="text-slate-300 text-sm mb-4">
          Send <span className="text-[#c5a059] font-bold text-lg">${amount}</span> from your Mobile Purse?
        </p>
